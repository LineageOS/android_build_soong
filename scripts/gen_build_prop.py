<<<<<<< HEAD   (c80e6e Merge tag 'android-security-13.0.0_r18' into staging/lineage)
=======
#!/usr/bin/env python3
#
...
def append_additional_system_props(args):
  ...
  if config["BuildVariant"] == "user" or config["BuildVariant"] == "userdebug":
    ...
    props.append("security.perf_harden=0")
...
if __name__ == "__main__":
  main()
>>>>>>> CHANGE (e11430 straight up rekt)
